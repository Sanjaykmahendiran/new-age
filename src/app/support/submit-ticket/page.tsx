...
export default function SubmitTicket() {
        ...
        <div className="max-w-7xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide all necessary details so our team can assist you better.
              </CardDescription>
            </CardHeader>
            <CardContent>
  ...
  <div className="flex flex-col space-y-2">
    ...
    >
      <SelectTrigger className={errors.category ? "border-red-500 " : "w-full"}>
  ...
  <div className="flex flex-col space-y-2">
    ...
    >
      <SelectTrigger className={errors.priority ? "border-red-500 " : "w-full"}>
...
<div className="space-y-2">
  ...
  <Textarea
    ...
    className={`min-h-[100px] resize-none ${errors.description ? "border-red-500 focus:ring-red-500" : ""}`}
      ...
      <span className="text-xs text-gray-400">Minimum 10 characters</span>
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed rounded-xl p-6 text-center bg-white hover:bg-gray-100 transition-colors">
                    ...
                    <p className="text-sm mt-2">Drag & drop or click to upload files</p>
                    <Input
                      type="file"
                      multiple
                      id="file-upload"
